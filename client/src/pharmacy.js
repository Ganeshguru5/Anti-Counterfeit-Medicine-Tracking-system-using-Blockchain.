...
purchase(val.product_details.product_price,val.bought_by_address) 
     }
...
<h6 class="display-6 text-danger text-center">claim list</h6>
{
    ...
    <Card style={{ width: '14rem' }} className="mb-4">
      ...
      onClick={()=>{
        var amount = prompt("Please enter amount")
            ...
            if (amount != null) {
              val.product_details.product_price=amount
            }
       
console.log(val.product_details.product_price);
console.log(data);
